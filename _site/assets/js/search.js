...
// ../../local/bun-deps/node_modules/lunr/lunr.js
var require_lunr = __commonJS((exports, module) => {
  (function() {
...
(function initializeSearch() {
  ...
  function createSearchResultElement(item, isLast) {
  ...
  function buildSearchIndex(store) {
    return import_lunr.default(function() {
      this.field("id");
  ...
  function performSearch() {
    ...
    const searchBox = document.getElementById(ELEMENT_IDS.SEARCH_BOX);
    if (searchBox) {
      searchBox.focus();
    }
    if (!searchTerm) {
