---
slug: how-to-install-yosemite-and-ubuntu-linux
...
- ubuntu linux
- linux
aliases: /post/99231293399/how-to-install-yosemite-and-ubuntu-linux
---
...
The only drawback with this approach as far as I can tell is that you lose the OS X recovery partition. For me however, that’s not a big deal, as I can always boot it off of a USB drive or SD card. A guide on how to create such device can be found [here](/2014/09/18/create-a-bootable-usb-drive-for-yosemite-the-easy/).
