---
slug: so-you-want-to-build-a-remote-company
url: /remote-work/2019/07/14/so-you-want-to-build-a-remote-company/
...
Since the article, I’ve started a [series of articles](/remote-work/) on remote work. In this article, I will explore the topic of creating a remote company. I briefly touched on this topic in the initial article, but in this article, I will explore this in greater detail and include things like how to setup a company, to how to hire and what tools I personally I find necessary to get off the ground (including the reasons for these tools).
